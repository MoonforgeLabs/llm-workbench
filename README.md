...
> `python3 references/knowledge/litellm-workbench/scripts/build-codex-oss-model-catalog.py`。
...
curl -s https://openrouter.ai/api/v1/models \
  -H "Authorization: Bearer $(grep OPENROUTER_API_KEY ~/Documents/myCode/references/knowledge/litellm-workbench/litellm_env.sh | cut -d'"' -f2)" \
...
**配置文件位置**：
```
/Users/alex/Documents/myCode/references/knowledge/litellm-workbench/litellm_config.yaml
```
